# Women Who Go - Code of Conduct

GoBridge (GB) and Women Who Go (WWG) uses the Go CoC as our base document:

[Go CoC](https://golang.org/conduct) | [Go Forum](https://forum.golangbridge.org/) | [Gophers Slack](http://invite.slack.golangbridge.org) | [Women Who Go Slack](https://womenwhogo.org/invite.html)
